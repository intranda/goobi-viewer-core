...
class SearchSortingOptionTest extends AbstractTest {
     ...
     */
    @Test
    void SearchSortingOption_shouldSetAscendingFieldCorrectly() {
     ...
     */
    @Test
    void SearchSortingOption_shouldSetDescendingFieldCorrectly() {
        SearchSortingOption option = new SearchSortingOption("!SORT_TITLE");
     ...
     */
    @Test
    void getLabel_shouldReturnTranslationOfRANDOMIfFieldRANDOM() {
     ...
     */
    @Test
    void getLabel_shouldReturnTranslationOfRANDOMIfFieldRandomSeed() {
     ...
     */
    @Test
    void getLabel_shouldReturnTranslationOfDEFAULT_SORT_FIELD_LABELIfFieldRELEVANCE() {
     ...
     */
    @Test
    void getSortString_shouldAddExclamationMarkPrefixIfDescending() {
        SearchSortingOption option = new SearchSortingOption("!SORT_TITLE");
