...
var viewerJS = ( function( viewer ) {
    ...
    viewer.fullscreen = {
        ...
        init: function( config ) {
            ...
            // reset bs tooltips for sidebar
            $( '.widget-toc__title-expand [data-toggle="tooltip"]' ).tooltip( 'destroy' );
            $( '.widget-toc__title-expand [data-toggle="tooltip"]' ).tooltip( {
            	placement: 'bottom'
            } );

            // reset bs popovers for sidebar
            $( '.fullscreen__view-sidebar-signal [data-toggle="popover"]' ).popover( 'destroy' );
            $( '.fullscreen__view-sidebar-signal [data-toggle="popover"]' ).popover( {
            	placement: 'bottom'
            } );
