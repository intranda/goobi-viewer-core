...
//         }
     ...
     imageView.Image.prototype.getTileSource = function(index) {
         ...
         console.log("tileSources", this.viewer.tileSources, index);
     ...
     imageView.Image.prototype.getRegionUrl = function(rect) {
         ...
         console.log("getRegionUrl", rect);
         let tileSource = this.getTileSource(tileSourceIndex);
         console.log("tileSource ", tileSource);
         let areaString = this.getAreaString(rect);
