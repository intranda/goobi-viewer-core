			...
			<controlfield tag="008">
				...
				<xsl:choose>
					...
					<xsl:when test="mods:originInfo/mods:place/mods:placeTerm[@type='code'][@authority='marccountry']">
						<!-- v3 fixed code reference and authority change-->
...
-->
	...
	<!-- v3 role-->
	<xsl:template match="mods:name[@type='personal' and mods:role/mods:roleTerm]">
		<xsl:call-template name="datafield">
	...
	<!-- v3 role -->
	<xsl:template match="mods:name[@type='corporate' and mods:role/mods:roleTerm='creator']">
		<xsl:call-template name="datafield">
	...
	<!-- v3 role -->
	<xsl:template match="mods:name[@type='conference' and mods:role/mods:roleTerm='creator']">
		<xsl:call-template name="datafield">
