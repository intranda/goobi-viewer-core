 ...
 * 
 * Last modified on 2012-05-09 by intranda GmbH
 *
...
public class ContentDeliveryServlet extends HttpServlet {
        ...
        if (this.basePath == null) {
            ...
            if (!path.exists()) {
                ...
                throw new ServletException(
                        "FileServlet init param 'basePath' value '" + this.basePath + "' is actually not a directory in file system.");
            } else if (!path.canRead()) {
                throw new ServletException(
                        "FileServlet init param 'basePath' value '" + this.basePath + "' is actually not readable in file system.");
            }
        }
    }
    ...
    protected void doHead(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        processRequest(request, response, false, null, null);
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        processRequest(request, response, true, null, null);
    }
     ...
     */
    public void processRequest(HttpServletRequest request, HttpServletResponse response, boolean content, String filePath, String mimeType)
            throws IOException {
        File file = null;
        ...
        if (range != null) {
            ...
            if (ranges.isEmpty()) {
                for (String part : range.substring(6)
                        .split(",")) {
