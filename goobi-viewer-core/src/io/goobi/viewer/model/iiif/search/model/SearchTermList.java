...
/**
 * A collection of search terms. If a {@link SearchTerm} is to be added which already exists in the list, the {@link SearchTerm#getCount()} is increased by one instead
 * 
 * @author florian
 *
 */
