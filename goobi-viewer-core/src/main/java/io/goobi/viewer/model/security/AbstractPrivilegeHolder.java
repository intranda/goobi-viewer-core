...
public abstract class AbstractPrivilegeHolder implements IPrivilegeHolder {
    ...
    protected static final String[] PRIVS_RECORD =
            { PRIV_LIST, PRIV_VIEW_THUMBNAILS, PRIV_VIEW_IMAGES, PRIV_VIEW_VIDEO, PRIV_VIEW_AUDIO, PRIV_VIEW_CMS, PRIV_VIEW_FULLTEXT,
                    PRIV_VIEW_METADATA, PRIV_ZOOM_IMAGES, PRIV_DOWNLOAD_IMAGES, PRIV_DOWNLOAD_ORIGINAL_CONTENT, PRIV_DOWNLOAD_PAGE_PDF,
                    PRIV_DOWNLOAD_PDF, PRIV_DOWNLOAD_METADATA, PRIV_GENERATE_IIIF_MANIFEST, PRIV_VIEW_UGC, PRIV_DOWNLOAD_BORN_DIGITAL_FILES,
