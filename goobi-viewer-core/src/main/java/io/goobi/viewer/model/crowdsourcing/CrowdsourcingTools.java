...
public final class CrowdsourcingTools {
     ...
     * @return true if given user owns any user groups assigned to campaigns; false otherwise
     * @throws DAOException
     */
    public static boolean isUserOwnsAnyCampaigns(User user) throws DAOException {
        ...
        for (Campaign campaign : DataManager.getInstance().getDao().getAllCampaigns()) {
