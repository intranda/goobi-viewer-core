...
public enum CustomWidgetType implements WidgetContentType {
     ...
     */
    WIDGET_RSSFEED("cms__add_widget__select_rss_title", "cms__add_widget__select_rss_desc", "rss", "widget_rssFeed.xhtml"),
    /**
     ...
     */
    WIDGET_FIELDFACETS("cms__add_widget__field_content__title", "cms__add_widget__field_content__desc", "list", "widget_fieldFacets.xhtml"),
    /**
    ...
    private CustomWidgetType(String label, String description, String iconName, String filename) {
        this.label = label;
