...
/**
 * Abstract base class for asynchronous download jobs that generate files (e.g. PDF or EPUB) for digitized records. Manages job state, file locking,
 * expiry, and user notification via e-mail.
 */
