...
public interface IPrivilegeHolder {
    ...
    public static final String[] PRIVS_RECORD =
            { PRIV_LIST, PRIV_VIEW_IMAGES, PRIV_VIEW_THUMBNAILS, PRIV_VIEW_FULLTEXT, PRIV_VIEW_VIDEO, PRIV_VIEW_AUDIO, PRIV_DOWNLOAD_PDF,
                    PRIV_DOWNLOAD_PAGE_PDF, PRIV_DOWNLOAD_ORIGINAL_CONTENT, PRIV_DOWNLOAD_METADATA, PRIV_GENERATE_IIIF_MANIFEST };
