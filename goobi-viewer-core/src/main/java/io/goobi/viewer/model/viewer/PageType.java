...
public enum PageType {
    ...
    adminCmsHighlightedObjects("admin/cms/highlightedobjects", "admin__highlights__title", adminDashboard),
    adminCmsHighlightedObjectsNew("admin/cms/highlightedobjects/new", "admin__highlights__new_title", adminCmsHighlightedObjects),
    adminCmsHighlightedObjectsEdit("admin/cms/highlightedobjects/edit", "admin__highlights__edit_title", adminCmsHighlightedObjects),
