...
public enum PageType {
    ...
    adminCmsScheduledObjects("admin/cms/scheduledobjects", "admin__scheduled_objects__title", adminDashboard),
    adminCmsScheduledObjectsNew("admin/cms/scheduledobjects/new", "admin__scheduled_objects__new_title", adminCmsScheduledObjects),
    adminCmsScheduledObjectsEdit("admin/cms/scheduledobjects/edit", "admin__scheduled_objects__edit_title", adminCmsScheduledObjects),
