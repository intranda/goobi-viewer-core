...
public enum PageType {
    ...
    adminCmsHighlightNew("admin/cms/highlights/new", "admin__highlights__new_title", adminCmsHighlights),
    adminCmsHighlightEdit("admin/cms/highlights/edit", "admin__highlights__edit_title", adminCmsHighlights),
