...
public enum PageType {
    ...
    adminDynamicCollectionNew("admin/cms/collections/dynamic/new", "admin__dynamic_collections_add", adminCmsCollections),
    adminDynamicCollectionEdit("admin/cms/collections/dynamic/edit", "admin__dynamic_collections_edit", adminCmsCollections),
    ...
    public static PageType getPageTypeForDocStructType(String docStructType) {
        ...
        if (preferredPageType != null) {
            // logger.trace("Found preferred page type: {}", preferredPageType.getName()); //NOSONAR Debug
            return preferredPageType;
        } else if (defaultPageType != null) {
            // logger.trace("Found default page type: {}", defaultPageType.getName()); //NOSONAR Debug
