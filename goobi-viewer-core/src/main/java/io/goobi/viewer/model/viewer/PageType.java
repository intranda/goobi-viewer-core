...
public enum PageType {
    ...
    adminCmsHighlightedObjects("admin/cms/highlightedobjects", "admin__highlighted_objects__title", adminDashboard),
    adminCmsHighlightedObjectsNew("admin/cms/highlightedobjects/new", "admin__highlighted_objects__new_title", adminCmsHighlightedObjects),
    adminCmsHighlightedObjectsEdit("admin/cms/highlightedobjects/edit", "admin__highlighted_objects__edit_title", adminCmsHighlightedObjects),
