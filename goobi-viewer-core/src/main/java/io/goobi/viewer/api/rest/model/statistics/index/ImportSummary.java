 ...
 *
 * @param pages total number of page documents in the index
 * @param fulltexts total number of page documents with full-text content
 */
public record ImportSummary(long pages, long fulltexts) {
}
