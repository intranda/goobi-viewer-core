...
import static io.goobi.viewer.api.rest.v2.ApiUrls.RECORDS_IMAGE_IIIF;
import static io.goobi.viewer.api.rest.v2.ApiUrls.RECORDS_IMAGE_INFO;
...
public class RecordsImageResource {
    ...
    @Operation(summary = "IIIF image identifier for the representative image of the process given by the identifier. Returns a IIIF 3.0 image information object", tags = { "iiif", "records" })
