...
public class ViewerRecordEPUBResource extends MetsPdfResource {

    private static final Logger logger = LoggerFactory.getLogger(ViewerRecordEPUBResource.class);

    public ViewerRecordEPUBResource(
        ...
        super(context, request, response, "epub", pi + ".xml");
        request.setAttribute("pi", pi);
    }

    @GET
    @Path(ApiUrls.RECORDS_EPUB)
    @Produces("application/epub+zip")
    @ContentServerPdfBinding
    public StreamingOutput getEpub() throws NotImplementedException {
        throw new NotImplementedException("Epub creation is not implemented in goobi viewer");
    }
