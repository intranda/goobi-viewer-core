...
public class OAuthServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            for (HttpAuthenticationProvider provider : listener.getProviders()) {
                if (provider instanceof OpenIdProvider openIdProvider) {
                    try {
                        boolean found = handleResponse(oar, openIdProvider, request, response);
                        if (found) {
                        ...
                        logger.error(e.getMessage(), e);
                        redirected = openIdProvider.completeLogin(null, request, response);
                        listener.unregister(provider);
