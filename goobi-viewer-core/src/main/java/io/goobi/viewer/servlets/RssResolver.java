...
public class RssResolver extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // logger.trace("RSS request filter query: {}", filterQuery); //NOSONAR Logging sometimes needed for debugging
        ...
        try {
            ...
            // logger.trace("RSS query: {}", query); //NOSONAR Logging sometimes needed for debugging
