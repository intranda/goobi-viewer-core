...
public class JPAClassLoader extends ClassLoader {
    ...
    public Enumeration<URL> getResources(final String name) throws IOException {
        // logger.trace("getResources: {}", name); //NOSONAR Logging sometimes needed for debugging
        if (PERSISTENCE_XML.equals(name)) {
            if (newUrl == null) {
                try {
                    ...
                    // logger.trace("persistence.xml\n{}", new XMLOutputter().outputString(docMerged)); //NOSONAR Logging sometimes needed for debugging
