...
public class MessageGenerator {
    ...
    public static String submitInternalTicket(Object ticket, String queueType, String ticketType, Integer processid) throws JMSException {
        ...
        Connection conn = connFactory.createConnection(DataManager.getInstance().getConfiguration().getActiveMQUsername(), DataManager.getInstance().getConfiguration().getActiveMQPassword());
