...
var Crowdsourcing = ( function(crowdsourcing) {
    ...
    crowdsourcing.Item = function(item, initialCanvasIndex) {
        ...
        if(this.showLog) {
            this.log = item.log;
            this.newLogMessages = []; //messages to add to the server status update to persist them
        }
    ...
    crowdsourcing.Item.prototype.addLogMessage = function(message) {
        ...
        this.newLogMessages.push(message);
    }
    
    /**
     * Resets the newLogMessages so they won't be sent again at the next save acton
     */
    crowdsourcing.Item.prototype.resetLog = function() {
        this.newLogMessages = [];
    }
