...
var viewerJS = (function (viewer) {
    ...
    var _messageKeys = [
        'bookmarkList_reset',
        'bookmarkList_delete',
        'bookmarkList_session_mail_sendList',
        'action__search_in_bookmarks',
        'bookmarkList_resetConfirm',
        'bookmarkList_noItemsAvailable',
        'bookmarkList_selectBookmarkList',
        'bookmarkList_addNewBookmarkList',
        'viewMiradorComparison',
        'bookmarkList_type_label',
        'bookmarkList_typeRecord',
        'bookmarkList_typePage',
        'bookmarkList_overview_all',
        'admin__crowdsourcing_campaign_statistics_numRecords',
        'bookmarkList_removeFromBookmarkList',
        'bookmarks',
    ];
    ...
    var _bookmarks = {
        ...
        renderSessionBookmarksDropdown: function () {
            ...
            $button.on('click', (event) => {
                ...
                $(event.currentTarget)
                    .next('.bookmark-navigation__dropdown')
                    .fadeToggle('fast')
