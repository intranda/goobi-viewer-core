    ...
    viewer.chronoSlider = {
        ...
        init: function (config) {
            ...
            $('#chronoSlider').slider({
                ...
                values: [
                    _defaults.yearList.indexOf(_defaults.currentMinRangeValue),
                    _defaults.yearList.indexOf(_defaults.currentMaxRangeValue),
                ],
                slide: function (event, ui) {
                    ...
                    if (rtl) {
                        ...
                        // set handler position
                        $('#chronoSlider .ui-slider-handle')
                            .last()
                            .css(
                                'margin-left',
                                -1 *
                                    $('#chronoSlider .ui-slider-handle').last().width() *
                                    ($('#chronoSlider').slider('values', 1) /
                                        $('#chronoSlider').slider('option', 'max'))
                            );
                        $('#chronoSlider .ui-slider-handle')
                            .first()
                            .css(
                                'margin-left',
                                -1 *
                                    $('#chronoSlider .ui-slider-handle').first().width() *
                                    ($('#chronoSlider').slider('values', 0) /
                                        $('#chronoSlider').slider('option', 'max'))
                            );
                    }
                },
            ...
            if (rtl) {
                ...
                $('#chronoSlider .ui-slider-handle')
                    ...
                    .css(
                        ...
                        -1 *
                            $('#chronoSlider .ui-slider-handle').last().width() *
                            ($('#chronoSlider').slider('values', 1) / $('#chronoSlider').slider('option', 'max'))
                    );
                $('#chronoSlider .ui-slider-handle')
                    .first()
                    .css(
                        ...
                        -1 *
                            $('#chronoSlider .ui-slider-handle').first().width() *
                            ($('#chronoSlider').slider('values', 0) / $('#chronoSlider').slider('option', 'max'))
                    );
            }

            // reset slider
            if (
                _defaults.startValue > _defaults.yearList[0] ||
                _defaults.endValue < _defaults.yearList[_defaults.yearList.length - 1]
            ) {
