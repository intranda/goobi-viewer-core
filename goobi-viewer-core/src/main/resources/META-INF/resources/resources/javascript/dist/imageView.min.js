...
var ImageView = ( function( imageView ) { 
    ...
    imageView.Tools.Filter.ColorRotate = function(image, value) {
        if ( _debug ) {
            console.log( '##############################' );
            console.log( 'imageView.tools.Filter.ColorRotate.init' );
            console.log( '##############################' );
        }
        this.value = value;
        imageView.Tools.Filter.call(this, image, this.filter); 
    ...
    imageView.Tools.Filter.ColorRotate.prototype.filter = function(pixels) {
        ...
        for(let i = 0; i < data.length; i += 4) {
            data[i] = matrix[0]*data[i] + matrix[1]*data[i+1] + matrix[2]*data[i+2];
            data[i+1] = matrix[3]*data[i] + matrix[4]*data[i+1] + matrix[5]*data[i+2];
            data[i+2] = matrix[6]*data[i] + matrix[7]*data[i+1] + matrix[8]*data[i+2];
        }
        return pixels;
    }
