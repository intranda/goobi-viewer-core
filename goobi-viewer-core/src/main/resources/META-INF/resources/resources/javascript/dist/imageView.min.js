...
//                            controls.setPanning(false);
        ...
        imageView.Controls.prototype.goHome = function( immediate ) {
            ...
            let homeBounds = this.image.viewer.viewport.getHomeBounds();
            homeBounds.y = this.image.sequence?.getCurrentImagePosition();
            if(isNaN(homeBounds.y)) {
                homeBounds.y = 0;
            }
            this.image.viewer.viewport.fitBounds(homeBounds, true);
            ...
            this.image.observables.viewerOpen.subscribe(openEvent => {
                ...
                this.image.viewer.element.addEventListener("wheel", wheelEvent => {
                    ...
                    if(wheelEvent.ctrlKey) {
                        this.image.viewer.viewport.zoomBy(wheelEvent.deltaY > 0 ? 1/this.zoomSpeed : this.zoomSpeed, false);
                    } else {
