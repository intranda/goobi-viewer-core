            ...
            if( image.observables ) {
                if(image.sequence) {
                    image.observables.firstTileLoaded.subscribe(e => {
                        ...
                        let imageOffset = this.image.sequence.getCurrentImagePosition();
                        this.baseYOffset = this.image.viewer.viewport.getBounds(false).y - imageOffset;
...
//    var _fadeout = null;
    ...
    imageView.Sequence = function(config, image) {
            ...
            this.setCurrentImage = function(imageIndex, immediate) {
