...
var ImageView = ( function(imageView) {
    ...
    imageView.Overlay.prototype.draw = function() {
        if(this.element) {
            ...
            rect.y += rect.height;
//            rect.height = 0.05;
//            let eleRect = this.viewer.viewport.viewportToViewerElementRectangle(this.rect);
//            console.log("draw ", eleRect, this.element);
//            this.element.width = eleRect.width;
//          var rect = ImageView.CoordinateConversion.convertCoordinatesFromImageToCanvas(this.rect, this.viewer).times(window.devicePixelRatio);
          if(!this.hidden) {
    ...
    function _drawRect(event) {
        ...
        if(!overlay.hidden) {
            ...
            if(overlay.rotateWithImage) {                
                ...
                context.rect(rect.x, rect.y, rect.width-parseInt(overlay.style.borderWidth)/2, rect.height);
                context.stroke();
...
var ImageView = ( function( imageView ) { 
    ...
    imageView.Tools.Filter.HighlightArea.prototype.filter = function(pixels) {
        ...
        let data = pixels.data;
        let rect = imageView.CoordinateConversion.convertCoordinatesFromImageToCanvas(this.rect, this.image.viewer);
        console.log("filter ", rect, pixels);
        for(var i = 0; i < data.length; i += 4) {
            let p = i/4;
