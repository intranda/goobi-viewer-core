     ...
     imageView.Image.prototype.loadFooter = function() {
         ...
         if ( this.config.image.baseFooterUrl && this.config.global.bottomMargin() > 0 ) {                
             ...
             this.footerImage.onload = function() {
                 ...
                 _drawFooter(image);
                 defer.resolve(image.footerImage);
             };
             ...
             defer.reject("no footer to load");
         }
...
//         }
     ...
     imageView.Image.prototype.getRegionUrl = function(rect) {
         ...
         if (typeof rect === 'string' || rect instanceof String) {  
             ...
             console.log("got tilesource ", tileSource);
    ...
    imageView.Overlay.prototype.draw = function() {
        ...
        if(this.label) {
            ...
            if(!this.hidden) {
                ...
                $svg.attr("viewBox", "0 0 " + 100 * 10 * rect.width + " 100");
                this.viewer.addOverlay({
                    element: this.label,
                    location: rect,                
                });                
    ...
    function _drawRect(event) {
        ...
        if(!overlay.hidden) {
            ...
            if(overlay.rotateWithImage) {                
               let imageRect = overlay.viewer.viewport.viewportToImageRectangle(overlay.rect);
               let imageRectRotated = imageRect.rotate(overlay.viewer.viewport.getRotation());
               console.log("overlay rect = " + overlay.rect);
               console.log("image rect "+ imageRect);
               console.log("image rect rotated" + imageRectRotated);

            } else {
            }
            rect = ImageView.CoordinateConversion.convertCoordinatesFromImageToCanvas(overlay.rect, overlay.viewer).times(window.devicePixelRatio);
                context.beginPath();        
