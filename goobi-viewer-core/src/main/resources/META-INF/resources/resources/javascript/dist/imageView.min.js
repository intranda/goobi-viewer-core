            ...
            if( image.observables ) {
                if(image.sequence) {
                    image.observables.firstTileLoaded.subscribe(e => {
                        ...
                        console.log("base offset is ", this.baseYOffset)
        ...
        imageView.Controls.prototype.goHome = function( immediate ) {
            ...
            if(this.image.sequence) {
                ...
                if(imageBounds) {
                    ...
                    console.log("fit bounds ", imageBounds);
...
//    var _fadeout = null;
    ...
    imageView.Sequence = function(config, image) {
            ...
            this.getCurrentImageBounds = function() {
                console.log("get current image bounds", this.currentImage, this.locations.get(this.currentImage));
                return this.locations.get(this.currentImage)?.clone();
            }
            ...
            this.setCurrentImage = function(id, immediate) {
                console.log("Sequence: set current image " + id);
