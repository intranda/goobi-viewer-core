...
riot.tag2('chronologyslider', '<p class="widget__description-text widget-chronology-slider__description-text" ref="descriptionText" hidden></p><div class="widget-chronology-slider__group" role="group" aria-labelledby="{opts.groupLabelId}"><div class="widget-chronology-slider__item chronology-slider-start"><input ref="inputStart" data-input="number" class="widget-chronology-slider__item-input -no-outline -active-border" riot-value="{startYear}" title="{msg.enterYearStart}" data-toggle="tooltip" data-placement="top" aria-label="{msg.enterYearStart}"></input></div><div class="widget-chronology-slider__item chronology-slider-end"><input ref="inputEnd" data-input="number" class="widget-chronology-slider__item-input -no-outline -active-border" riot-value="{endYear}" title="{msg.enterYearEnd}" data-toggle="tooltip" data-placement="top" aria-label="{msg.enterYearEnd}"></input></div></div><div class="widget-chronology-slider__item chronology-slider"><div class="widget-chronology-slider__slider" ref="slider"></div></div>', '', '', function(opts) {
...
this.getAriaLabel = function(canvas, index) {
...
this.needsKeyboardFocus = function(canvas) {
...
this.handleKeydownOnImage = function(event) {
	event.preventUpdate = true;
