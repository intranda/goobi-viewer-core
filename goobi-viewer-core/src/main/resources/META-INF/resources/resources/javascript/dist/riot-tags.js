...
riot.tag2('geomapsearch', '<div class="geo-map__wrapper"><div ref="geocoder" class="geocoder"></div><div class="geo-map__buttons-wrapper"><button class="btn btn--default geo-map__reset-search">#{msg.reset}</button><button class="btn btn--full geo-map__submit-search">#{msg.search}</button></div><div ref="map" class="geo-map"></div></div>', '', '', function(opts) {
