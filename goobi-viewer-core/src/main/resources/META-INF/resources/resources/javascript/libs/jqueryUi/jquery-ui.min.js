                ...
                for (i in n[o])
                    ((s = n[o][i]),
                        r.call(n[o], i) &&
                            void 0 !== s &&
                            (t.isPlainObject(s)
                                ? (e[i] = t.isPlainObject(e[i]) ? t.widget.extend({}, e[i], s) : t.widget.extend({}, s))
                                : (e[i] = s)));
            return e;
        }),
                    ...
                    !m.fn[e] &&
                        (m.fn[e] = function (s) {
                            var n,
                                ...
                                r,
                                l = y(s);
                            return ((o = (n = this[(r = 'alpha' === e ? (this._hsla ? 'hsla' : 'rgba') : t)]())[i.idx]),
                            'undefined' === l)
                                ? o
    ...
    (t.effects.define('blind', 'hide', function (e, i) {
        ...
        t.effects.define('bounce', function (e, i) {
            ...
            for (
                ...
                (((s = {})[m] = (_ ? '-=' : '+=') + u), a.animate(s, f, g).animate(n, f, g), (u = l ? 2 * u : u / 2));
        ...
        t.effects.define('explode', 'hide', function (e, i) {
            var s,
                ...
                g = [];
            function m() {
                (g.push(this), g.length === h * h && (c.css({ visibility: 'visible' }), t(g).remove(), i()));
            }
            for (s = 0; s < h; s++)
        ...
        t.effects.define('fade', 'toggle', function (e, i) {
            ...
            t(this)
                .css('opacity', +!s)
                .animate({ opacity: +!!s }, { queue: !1, duration: e.duration, easing: e.easing, complete: i });
        }),
        t.effects.define('fold', 'hide', function (e, i) {
            ...
            (a && (o = (parseInt(a[1], 10) / 100) * p[+('hide' !== n)]),
                ...
                s
                    .queue(function (i) {
                        (h &&
                            h.animate(t.effects.clipToBox(u), l, e.easing).animate(t.effects.clipToBox(d), l, e.easing),
                            i());
                    })
            ...
            return this.length
                ? this[0].labels && this[0].labels.length
                    ...
                    : ((s = this.eq(0).parents('label')),
                      (i = this.attr('id')) &&
                          ((n = (t = this.eq(0).parents().last()).add(t.length ? t.siblings() : this.siblings())),
        ...
        t.extend(P.prototype, {
                ...
                (i.append && i.append.remove(),
                    ...
                    ('button' === s || 'both' === s) &&
                        ...
                        this._get(i, 'buttonImageOnly')
                            ? (i.trigger = t('<img>').addClass(this._triggerClass).attr({ src: o, alt: n, title: n }))
                            : ((i.trigger = t("<button type='button'>").addClass(this._triggerClass)),
                              o ? i.trigger.html(t('<img>').attr({ src: o, alt: n, title: n })) : i.trigger.text(n)),
            ...
            _selectDay: function (e, i, s, n) {
                ...
                !(t(n).hasClass(this._unselectableClass) || this._isDisabledDatepicker(a[0])) &&
                    (((o = this._getInst(a[0])).selectedDay = o.currentDay = parseInt(t('a', n).attr('data-date'))),
                    ...
                    for (D = 0, C = '', this.maxRows = 4; D < V[1]; D++) {
                        ...
                        (++tt > 11 && ((tt = 0), te++),
                            (P +=
                                ...
                                (G
                                    ? '</div>' +
                                      (V[0] > 0 && D === V[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : '')
                                    : '')),
                            (C += P));
                    }
                    w += C;
    ...
    (t(document).on('mouseup', function () {
        ...
        t.widget('ui.mouse', {
            ...
            _mouseDown: function (e) {
                if (!z) {
                    ...
                    var i = this,
                        s = 1 === e.which,
                        n = 'string' == typeof this.options.cancel && t(e.target).closest(this.options.cancel).length;
                    return (
        ...
        t.widget('ui.resizable', t.ui.mouse, {
            ...
            _hasScroll: function (e, i) {
                ...
                if ('scroll' === o || e[(s = i && 'left' === i ? 'scrollLeft' : 'scrollTop')] > 0) return !0;
                try {
                    ((e[s] = 1), (n = e[s] > 0), (e[s] = 0));
                } catch (t) {}
                return n;
            ...
            _calculateAdjustedElementDimensions: function (t) {
                var e,
                    ...
                    s,
                    n = t.get(0);
                return 'content-box' === t.css('box-sizing') && (this._hasScroll(n) || this._hasScroll(n, 'left'))
                    ? ((e = parseFloat(n.style.width)),
                      ...
                      { height: (i = isNaN(i) ? this._getElementTheoreticalSize(t, s, 'height') : i), width: e })
                    : { height: parseFloat(t.css('height')), width: parseFloat(t.css('width')) };
            },
            _getElementTheoreticalSize: function (t, e, i) {
                return Math.max(0, Math.ceil(t.get(0)['offset' + i[0].toUpperCase() + i.slice(1)] - e[i] - 0.5)) || 0;
            },
        ...
        t.ui.plugin.add('resizable', 'ghost', {
            start: function () {
                ...
                ((e.ghost = e.originalElement.clone()),
                    ...
                    !0 === t.uiBackCompat && 'string' == typeof e.options.ghost && e.ghost.addClass(this.options.ghost),
            ...
            _create: function () {
                ...
                ((this.isover = !1),
                    ...
                    (this.proportions = function () {
                        if (!arguments.length)
                            return (
                                t || (t = { width: this.element[0].offsetWidth, height: this.element[0].offsetHeight })
                            );
                        t = arguments[0];
                    }),
                    ...
                    (this.element
                        ...
                        .each(function () {
                            ...
                            if (
                                ...
                                t.ui.intersect(s, t.extend(i, { offset: i.element.offset() }), i.options.tolerance, e)
                            )
                                return ((n = !0), !1);
                        }),
                    !n &&
        ...
        t.widget('ui.sortable', t.ui.mouse, {
            ...
            _clear: function (t, e) {
                ...
                if (
                    (this._storedStylesheet && (this._storedStylesheet.remove(), (this._storedStylesheet = null)),
        ...
        t.widget('ui.tabs', {
            ...
            _isLocal: function (t) {
                ...
                return t.hash.length > 1 && e.origin === i.origin && e.pathname === i.pathname && e.search === i.search;
            },
            _create: function () {
                var e = this,
                    i = this.options;
            ...
            _setOptionDisabled: function (e) {
                var i, s, n;
                for (
                    Array.isArray(e) && (e.length ? e.length === this.anchors.length && (e = !0) : (e = !1)), n = 0;
                    (s = this.tabs[n]);
                    n++
                )
                    ((i = t(s)),
