...
var viewerJS = (function (viewer) {
    ...
    viewer.notifications = {
        ...
        confirm: (message, confirmText, denyText, titleAlert, opts = {}) => {
            return viewer.translator.addTranslations(['cancel', 'ok', 'delete']).then(() => {
    ...
    function showJsfMessagesAsSweetAlert(e) {
        if (e == undefined || (e.responseText && e.responseText.includes('<ul id="messages">'))) {
            //only apply if messages div has been updated
    ...
    function initJsfConfirmationDialogs() {
        ...
        $('[data-require-confirmation="true"]').each((index, element) => {
            ...
            if (!element.hasConfirmationEvent) {
                ...
                element.onclick = (e) => {
                    ...
                    viewer.notifications
                        .confirm(undefined, confirmButtonText, cancelButtonText, confirmationText, opts)
                        .then(() => {
