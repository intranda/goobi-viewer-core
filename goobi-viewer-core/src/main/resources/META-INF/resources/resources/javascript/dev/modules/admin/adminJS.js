...
$(document).ready(function () {
    ...
    $('body').on('click', '[data-toggle="helptext"]', function () {
        $(this)
            .closest('.form-group')
            .children('.admin__form-input, .admin__license-functions-help')
            .find('.admin__form-help-text')
            .toggleClass('in');
    ...
    $('body').on('focus', '.admin__language-tabs-vertical-textarea', function () {
        $(this)
            .siblings('.admin__language-tabs-vertical')
            .find('.admin__language-tab-vertical.active a')
            .css({ 'border-color': '#3365a9', 'border-right-color': '#fff' });
    });
    ...
    $('body').on('focusout', '.admin__language-tabs-vertical-textarea', function () {
        $(this)
            .siblings('.admin__language-tabs-vertical')
            .find('.admin__language-tab-vertical.active a')
            .css({ 'border-color': '#ccc', 'border-right-color': '#fff' });
    });
