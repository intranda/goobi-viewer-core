...
public class IdentifierResolver extends HttpServlet {
    ...
    // private static IndexSearcher getSearcher() throws CorruptIndexException, IOException {
    // if (searcher == null) {
    // // searcher = new IndexSearcher(new SimpleFSDirectory(new File(LUCENE_INDEX_PATH)));
    // try {
    // searcher = LuceneHelper.getInstance().getIndexSearcher();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if ((targetDoc.getFieldValue(SolrConstants.ISWORK) == null || !((Boolean) targetDoc.getFieldValue(SolrConstants.ISWORK)))
                    && (targetDoc.getFieldValue(SolrConstants.ISANCHOR) == null || !((Boolean) targetDoc.getFieldValue(
            ...
            String result = constructUrl(pi, targetDoc, false, DataManager.getInstance().getConfiguration().isSidebarOverviewLinkVisible());
    ...
    private void doPageSearch(String fieldValue, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            String result = constructUrl(pi, targetDoc, true, DataManager.getInstance().getConfiguration().isSidebarOverviewLinkVisible());
     ...
     */
    static String constructUrl(String pi, SolrDocument targetDoc, boolean pageResolverUrl, boolean allowOverviewPage) throws DAOException {
