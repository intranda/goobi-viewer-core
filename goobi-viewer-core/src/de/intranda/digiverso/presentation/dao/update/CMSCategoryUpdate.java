...
/**
 * Converts all Tags and Classifications from previous viewer-cms versions to the {@link CMSCategory} system. This includes updating references in
 * CMSPages CMSContentItems and CMSMediaItems to keep the existing structure intact
 * 
 * @author florian
 *
 */
                ...
                if (category == null) {
                    ...
                    for (Long pageId : pageIds) {
                        try {
                            ...
                            logger.error("Error getting pages for category {}. Failed to load page for id {}", categoryName, pageId);
                        }
                    }
                }
            }
