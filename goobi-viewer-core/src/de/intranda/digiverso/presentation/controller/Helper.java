...
public class Helper {
     ...
     * @param dateString
     * @return
     * @should parse all supported formats correctly
    ...
    public static boolean postMail(List<String> recipients, String subject, String body) throws UnsupportedEncodingException, MessagingException {
        Helper.postMail(recipients, subject, body, DataManager.getInstance().getConfiguration().getSmtpServer(), DataManager.getInstance()
    ...
    public static String getLocalDate(Date date, String language) {
        switch (language) {
            ...
            default:
                return Helper.formatterENDateTime.print(date.getTime());
        }
    }
