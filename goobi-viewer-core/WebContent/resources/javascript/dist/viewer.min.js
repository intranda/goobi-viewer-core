...
var viewerJS = ( function( viewer ) {
    ...
    viewer.userLogin = {
            ...
            init : function() {
            	...
            	$( 'body' ).on( 'click', '#userLogin', function( event ) {
            	...
            	$( 'body' ).on( 'click', '[data-open="retrieve-account"]', function() {
            		$( '#loginTypeExternal, #loginTypeLocale, #loginTypeCreateAccount' ).hide();
            	...
            	$( 'body' ).on( 'click', '[data-open="create-account"]', function() {
            		$( '#loginTypeExternal, #loginTypeLocale, #loginTypeRetrieveAccount' ).hide();
