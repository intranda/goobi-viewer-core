...
<xsl:template match="oai:header">
  ...
  <table class="values">
    ...
    <td class="value">
      ...
      <xsl:text> </xsl:text><a class="link" href="http://dfg-viewer.de/v1/?set[mets]=http%3A%2F%2Flocalhost%2Foai%2F%3Fverb%3DGetRecord%26metadataPrefix%3Dmets%26identifier%3D{oai:identifier}">DFG-Viewer</a>
