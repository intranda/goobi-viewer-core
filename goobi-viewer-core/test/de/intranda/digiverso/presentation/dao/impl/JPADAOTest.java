...
public class JPADAOTest extends AbstractDatabaseEnabledTest {
    ...
    public void getAllUsersTest() throws DAOException {
        List<User> users = DataManager.getInstance()
                .getDao()
                .getAllUsers(false);
    ...
    public void getUserByIdTest() throws DAOException {
        ...
        Assert.assertEquals(2, user.getOpenIdAccounts()
                .size());
    }
    ...
    public void getUserByOpenIdTest() throws DAOException {
        User user = DataManager.getInstance()
                .getDao()
                .getUserByOpenId("user_1_claimed_identifier_2");
        Assert.assertNotNull(user);
    }
    ...
    public void addUserTest() throws DAOException {
        ...
        User user2 = DataManager.getInstance()
                .getDao()
                .getUser(user.getId());
    ...
    public void updateUserTest() throws DAOException {
        Assert.assertEquals(2, DataManager.getInstance()
                .getDao()
                .getAllUsers(false)
                .size());
        User user = DataManager.getInstance()
    ...
    public void deleteUserTest() throws DAOException {
        ...
        Assert.assertNotNull(DataManager.getInstance()
                .getDao()
                .getUser(user.getId()));
        Assert.assertTrue(DataManager.getInstance()
                .getDao()
                .deleteUser(user));
        Assert.assertNull(DataManager.getInstance()
                .getDao()
                .getUserByEmail("deleteme@b.com"));
    }
    ...
    public void userLicenseTest() throws DAOException {
        User user = DataManager.getInstance()
                ...
                .getUser(2);
        Assert.assertNotNull(user);
        Assert.assertEquals(1, user.getLicenses()
                .size());
        Assert.assertEquals(1, user.getLicenses()
                .get(0)
                .getPrivileges()
                .size());
        for (String priv : user.getLicenses()
                .get(0)
                .getPrivileges()) {
        ...
        // Saving the licensee should not create any extra licenses
        {
            ...
            User user2 = DataManager.getInstance()
                    ...
                    .getUser(user.getId());
            Assert.assertNotNull(user2);
            Assert.assertEquals(1, user2.getLicenses()
                    .size());
        }
        ...
        // Adding a new license should update the attached object with ID
        {
            ...
            license.setLicenseType(user.getLicenses()
                    .get(0)
                    .getLicenseType());
            ...
            User user2 = DataManager.getInstance()
                    ...
                    .getUser(user.getId());
            Assert.assertNotNull(user2);
            Assert.assertEquals(2, user2.getLicenses()
                    .size());
            Assert.assertNotNull(user2.getLicenses()
                    .get(0)
                    .getId());
            Assert.assertNotNull(user2.getLicenses()
                    .get(1)
        ...
        user.removeLicense(user.getLicenses()
                .get(0));
        Assert.assertTrue(DataManager.getInstance()
                .getDao()
                .updateUser(user));
        User user3 = DataManager.getInstance()
                .getDao()
                .getUser(user.getId());
        Assert.assertNotNull(user3);
        Assert.assertEquals(1, user3.getLicenses()
                .size());
    ...
    public void getAllUserGroupsTest() throws DAOException {
        List<UserGroup> userGroups = DataManager.getInstance()
                .getDao()
                .getAllUserGroups();
    ...
    public void getUserGroupByIdTest() throws DAOException {
        UserGroup ug = DataManager.getInstance()
                .getDao()
                .getUserGroup(1);
        Assert.assertNotNull(ug);
        Assert.assertNotNull(ug.getOwner());
        Assert.assertEquals(Long.valueOf(1), ug.getOwner()
                .getId());
    ...
    public void getUserGroupByNameTest() throws DAOException {
        UserGroup userGroup = DataManager.getInstance()
                .getDao()
                .getUserGroup("user group 1 name");
        Assert.assertNotNull(userGroup);
        Assert.assertNotNull(userGroup.getOwner());
        Assert.assertEquals(Long.valueOf(1), userGroup.getOwner()
                .getId());
    ...
    public void addUserGroupTest() throws DAOException {
        User owner = DataManager.getInstance()
                .getDao()
                .getUser(1);
        ...
        UserGroup userGroup2 = DataManager.getInstance()
                .getDao()
                .getUserGroup(userGroup.getId());
        Assert.assertNotNull(userGroup2);
        Assert.assertNotNull(userGroup2.getOwner());
        Assert.assertEquals(userGroup.getOwner()
                .getId(),
                userGroup2.getOwner()
                        .getId());
    ...
    public void deleteUserGroupWithoutMembersTest() throws DAOException {
        ...
        Assert.assertNull(DataManager.getInstance()
                .getDao()
                .getUserGroup(2));
        Assert.assertEquals(1, DataManager.getInstance()
                .getDao()
                .getAllUserGroups()
                .size());
    }
    ...
    public void getAllUserRolesTest() throws DAOException {
        List<UserRole> userRoles = DataManager.getInstance()
                .getDao()
                .getAllUserRoles();
    ...
    public void getUserGroupMembershipsByUserGroupTest() throws DAOException {
        UserGroup userGroup = DataManager.getInstance()
                ...
                .getUserGroup(1);
        Assert.assertNotNull(userGroup);
        List<UserRole> memberships = DataManager.getInstance()
                .getDao()
                .getUserRoles(userGroup, null, null);
    ...
    public void getUserGroupMembershipsByRoleTest() throws DAOException {
        Role role = DataManager.getInstance()
                .getDao()
                .getRole(1);
        Assert.assertNotNull(role);
        List<UserRole> memberships = DataManager.getInstance()
                .getDao()
                .getUserRoles(null, null, role);
        Assert.assertNotNull(memberships);
        Assert.assertEquals(1, memberships.size());
    }
    ...
    public void userGroupLicenseTest() throws DAOException {
        UserGroup userGroup = DataManager.getInstance()
                ...
                .getUserGroup(1);
        Assert.assertNotNull(userGroup);
        Assert.assertEquals(1, userGroup.getLicenses()
                .size());
        Assert.assertEquals(1, userGroup.getLicenses()
                .get(0)
                .getPrivileges()
                .size());
        for (String priv : userGroup.getLicenses()
                .get(0)
                .getPrivileges()) {
        ...
        // Saving the licensee should not create any extra licenses
        {
            ...
            UserGroup userGroup2 = DataManager.getInstance()
                    ...
                    .getUserGroup(userGroup.getId());
            Assert.assertNotNull(userGroup2);
            Assert.assertEquals(1, userGroup2.getLicenses()
                    .size());
        }
        ...
        {
            License license = new License();
            license.setLicenseType(userGroup.getLicenses()
                    .get(0)
                    .getLicenseType());
            ...
            UserGroup userGroup2 = DataManager.getInstance()
                    ...
                    .getUserGroup(userGroup.getId());
            Assert.assertNotNull(userGroup2);
            Assert.assertEquals(2, userGroup2.getLicenses()
                    .size());
            Assert.assertNotNull(userGroup2.getLicenses()
                    .get(0)
                    .getId());
            Assert.assertNotNull(userGroup2.getLicenses()
                    .get(1)
        ...
        // Orphaned licenses should be deleted properly
        {
            userGroup.removeLicense(userGroup.getLicenses()
                    .get(0));
            Assert.assertTrue(DataManager.getInstance()
                    .getDao()
                    .updateUserGroup(userGroup));
            UserGroup userGroup3 = DataManager.getInstance()
                    .getDao()
                    .getUserGroup(userGroup.getId());
            Assert.assertNotNull(userGroup3);
            Assert.assertEquals(1, userGroup3.getLicenses()
                    .size());
        }
    }
    ...
    public void addUserRoleTest() throws DAOException {
        ...
        Assert.assertEquals(1, DataManager.getInstance()
                ...
                .getAllUserRoles()
                .size());
        Assert.assertEquals(0, DataManager.getInstance()
                .getDao()
                .getUserRoles(userGroup, user, role)
                .size());
        Assert.assertEquals(0, DataManager.getInstance()
                .getDao()
                .getUserRoles(userGroup, user, null)
                .size());
        Assert.assertEquals(0, DataManager.getInstance()
                .getDao()
                .getUserRoles(userGroup, null, null)
        ...
        UserRole userRole2 = DataManager.getInstance()
                .getDao()
                .getUserRoles(userGroup, user, role)
                .get(0);
    ...
    public void updateUserRoleTest() throws DAOException {
        Assert.assertEquals(1, DataManager.getInstance()
                ...
                .getAllUserRoles()
                .size());
        UserRole userRole = DataManager.getInstance()
                .getDao()
                .getAllUserRoles()
                .get(0);
        Assert.assertNotNull(userRole);

        Role role1 = DataManager.getInstance()
                .getDao()
                .getRole(1);
        Assert.assertNotNull(role1);
        Role role2 = DataManager.getInstance()
                .getDao()
                .getRole(2);
    ...
    public void getAllIpRangesTest() throws DAOException {
        List<IpRange> ipRanges = DataManager.getInstance()
                .getDao()
                .getAllIpRanges();
    ...
    public void getIpRangeByIdTest() throws DAOException {
        IpRange ipRange = DataManager.getInstance()
                .getDao()
                .getIpRange(1);
    ...
    public void addIpRangeTest() throws DAOException {
        ...
        Assert.assertEquals(3, DataManager.getInstance()
                .getDao()
                .getAllIpRanges()
                .size());

        IpRange ipRange2 = DataManager.getInstance()
                .getDao()
                .getIpRange(ipRange.getId());
    ...
    public void ipRangeLicenseTest() throws DAOException {
        IpRange ipRange = DataManager.getInstance()
                ...
                .getIpRange(1);
        Assert.assertNotNull(ipRange);
        Assert.assertEquals(1, ipRange.getLicenses()
                .size());
        Assert.assertEquals(1, ipRange.getLicenses()
                .get(0)
                .getPrivileges()
                .size());
        for (String priv : ipRange.getLicenses()
                .get(0)
                .getPrivileges()) {
            Assert.assertEquals(IPrivilegeHolder.PRIV_LIST, priv);
            break;
        ...
        IpRange ipRange2 = DataManager.getInstance()
                ...
                .getIpRange(ipRange.getId());
        Assert.assertNotNull(ipRange2);
        Assert.assertEquals(1, ipRange2.getLicenses()
                .size());

        // Orphaned licenses should be deleted properly
        ipRange.removeLicense(ipRange.getLicenses()
                .get(0));
        Assert.assertTrue(DataManager.getInstance()
                .getDao()
                .updateIpRange(ipRange));
        IpRange ipRange3 = DataManager.getInstance()
                .getDao()
                .getIpRange(ipRange.getId());
        Assert.assertNotNull(ipRange3);
        Assert.assertEquals(0, ipRange3.getLicenses()
                .size());
    }
    ...
    public void getAllCommentsTest() throws DAOException {
        List<Comment> comments = DataManager.getInstance()
                .getDao()
                .getAllComments();
    ...
    public void getCommentCount_shouldReturnCorrectCount() throws Exception {
        Assert.assertEquals(4L, DataManager.getInstance()
                .getDao()
    ...
    public void getCommentCount_shouldFilterCorrectly() throws Exception {
        ...
        filters.put("page", "1");
        Assert.assertEquals(3L, DataManager.getInstance()
                .getDao()
    ...
    public void getCommentByIdTest() throws DAOException {
        Comment comment = DataManager.getInstance()
                .getDao()
                .getComment(1);
        ...
        Assert.assertEquals(Long.valueOf(1), comment.getOwner()
                .getId());
        ...
        Assert.assertEquals(1, comment.getChildren()
                .size());

        Comment comment2 = DataManager.getInstance()
                .getDao()
                .getComment(2);
        Assert.assertEquals(comment, comment2.getParent());
        Assert.assertEquals(1, comment2.getChildren()
                .size());
    }
    ...
    public void getCommentsForPageTest() throws DAOException {
        List<Comment> comments = DataManager.getInstance()
                .getDao()
                .getCommentsForPage("PI 1", 1, false);
        Assert.assertEquals(3, comments.size());
        comments = DataManager.getInstance()
                .getDao()
                .getCommentsForPage("PI 1", 1, true);
        Assert.assertEquals(1, comments.size());
    }

    @Test
    public void addCommentTest() throws DAOException {
        Assert.assertEquals(4, DataManager.getInstance()
                .getDao()
                .getAllComments()
                .size());
        ...
        comment.setOwner(DataManager.getInstance()
                .getDao()
                .getUser(1));
        Assert.assertTrue(DataManager.getInstance()
                .getDao()
        ...
        Assert.assertEquals(5, DataManager.getInstance()
                .getDao()
                .getAllComments()
                .size());
    ...
    public void getAllSearchesTest() throws DAOException {
        List<Search> list = DataManager.getInstance()
                .getDao()
                .getAllSearches();
    ...
    public void getSearchByIdTest() throws DAOException {
        Search o = DataManager.getInstance()
                .getDao()
                .getSearch(1);
        Assert.assertNotNull(o);
        Assert.assertEquals(Long.valueOf(1), o.getId());
        Assert.assertNotNull(o.getOwner());
        Assert.assertEquals(Long.valueOf(1), o.getOwner()
                .getId());
    ...
    public void addSearchTest() throws DAOException {
        ...
        o.setOwner(DataManager.getInstance()
                .getDao()
                .getUser(1));
        ...
        Search o2 = DataManager.getInstance()
                .getDao()
                .getSearch(o.getId());
    ...
    public void getOpenAccessLicenseTypes_shouldOnlyReturnNonOpenAccessLicenseTypes() throws Exception {
        List<LicenseType> licenseTypes = DataManager.getInstance()
                .getDao()
                .getNonOpenAccessLicenseTypes();
        Assert.assertEquals(2, licenseTypes.size());
        Assert.assertEquals(Long.valueOf(1), licenseTypes.get(0)
                .getId());
        Assert.assertEquals(Long.valueOf(3), licenseTypes.get(1)
                .getId());
    }

    @Test
    public void getLicenseTypeByIdTest() throws DAOException {
        LicenseType licenseType = DataManager.getInstance()
                .getDao()
                .getLicenseType(1);
        ...
        Assert.assertEquals(1, licenseType.getPrivileges()
                .size());
    }
    ...
    public void getLicenseTypeByNameTest() throws DAOException {
        LicenseType licenseType = DataManager.getInstance()
                .getDao()
                .getLicenseType("license type 2 name");
        Assert.assertNotNull(licenseType);
    ...
    public void addLicenseTypeTest() throws DAOException {
        ...
        licenseType.getPrivileges()
                .add("license type to add priv 1");
        Assert.assertTrue(DataManager.getInstance()
                .getDao()
        ...
        LicenseType licenseType2 = DataManager.getInstance()
                .getDao()
                .getLicenseType(licenseType.getId());
        ...
        Assert.assertEquals(1, licenseType2.getPrivileges()
                .size());
        Assert.assertTrue(licenseType2.getPrivileges()
                .contains("license type to add priv 1"));
    }
    ...
    public void updateLicenseTypeTest() throws DAOException {
        ...
        Assert.assertEquals(licenseType.getName(), licenseType2.getName());
        Assert.assertEquals(licenseType.getDescription(), licenseType2.getDescription());
        Assert.assertEquals(2, licenseType.getPrivileges()
                .size());
    }
    ...
    public void getAllRolesTest() throws DAOException {
        List<Role> roles = DataManager.getInstance()
                .getDao()
                .getAllRoles();
    ...
    public void getRoleByIdTest() throws DAOException {
        ...
        Assert.assertEquals(1, role.getPrivileges()
                .size());
    }
    ...
    public void addRoleTest() throws DAOException {
        ...
        Assert.assertEquals(1, role2.getPrivileges()
                .size());
        Assert.assertTrue(role2.getPrivileges()
    ...
    public void updateRoleTest() throws DAOException {
        ...
        Assert.assertEquals(role.getName(), role2.getName());
        Assert.assertEquals(role.getDescription(), role2.getDescription());
        Assert.assertEquals(2, role.getPrivileges()
                .size());
    }
    ...
    public void getAllBookshelvesTest() throws DAOException {
        List<Bookshelf> bookshelves = DataManager.getInstance()
                .getDao()
                .getAllBookshelves();
    ...
    public void getPublicBookshelvesTest() throws DAOException {
        ...
        Assert.assertEquals(Long.valueOf(2), bookshelves.get(0)
                .getId());
    }
    ...
    public void getAllBookshelvesForUserTest() throws DAOException {
        ...
        List<Bookshelf> bookshelves = DataManager.getInstance()
                ...
                .getBookshelves(user);
        Assert.assertEquals(1, bookshelves.size());
        Assert.assertEquals(user, bookshelves.get(0)
                .getOwner());
    }
    ...
    public void getBookshelfByIdTest() throws DAOException {
        ...
        Assert.assertEquals(Long.valueOf(1), bookshelf.getOwner()
                .getId());
        ...
        // }
        Assert.assertEquals(2, bookshelf.getItems()
                .size());
    ...
    public void addBookshelfTest() throws DAOException {
        ...
        Bookshelf bookshelf2 = DataManager.getInstance()
                .getDao()
                .getBookshelf("add bookshelf test");
        ...
        Assert.assertEquals(1, bookshelf2.getItems()
                .size());
        BookshelfItem item2 = bookshelf2.getItems()
                .get(0);
    ...
    public void updateBookshelfTest() throws DAOException {
        ...
        int numBookshelves = DataManager.getInstance()
                .getDao()
                .getAllBookshelves()
                .size();
        ...
        int numBookshelves2 = DataManager.getInstance()
                .getDao()
                .getAllBookshelves()
                .size();
        ...
        Bookshelf bookshelf2 = DataManager.getInstance()
                .getDao()
                .getBookshelf(bookshelf.getId());
        Assert.assertNotNull(bookshelf2);
        Assert.assertEquals(bookshelf.getId(), bookshelf2.getId());
        Assert.assertEquals(bookshelf.getName(), bookshelf2.getName());
        Assert.assertEquals(bookshelf.getDescription(), bookshelf2.getDescription());
        Assert.assertEquals(3, bookshelf2.getItems()
                .size());
    }
    ...
    public void removeBookshelfItemTest() throws DAOException {
        ...
        Assert.assertEquals(2, bookshelf.getItems()
                .size());
        bookshelf.removeItem(bookshelf.getItems()
                .get(0));
        Assert.assertTrue(DataManager.getInstance()
                .getDao()
                .updateBookshelf(bookshelf));
    ...
    public void getComments_shouldSortResultsCorrectly() throws Exception {
        List<Comment> ret = DataManager.getInstance()
                .getDao()
                .getComments(0, 2, "text", true, null);
        Assert.assertEquals(2, ret.size());
        Assert.assertEquals(Long.valueOf(4), ret.get(0)
                .getId());
        Assert.assertEquals(Long.valueOf(3), ret.get(1)
                .getId());
    }
    ...
    public void getComments_shouldFilterResultsCorrectly() throws Exception {
        ...
        List<Comment> ret = DataManager.getInstance()
                .getDao()
                .getComments(0, 2, null, true, filterMap);
        Assert.assertEquals(1, ret.size());
        Assert.assertEquals("comment 2 text", ret.get(0)
                .getText());
    }
    ...
    public void getUserGroups_shouldSortResultsCorrectly() throws Exception {
        List<UserGroup> userGroups = DataManager.getInstance()
                .getDao()
                .getUserGroups(0, 2, "name", true, null);
        Assert.assertEquals(2, userGroups.size());
        Assert.assertEquals(Long.valueOf(2), userGroups.get(0)
                .getId());
        Assert.assertEquals(Long.valueOf(1), userGroups.get(1)
                .getId());
    }
    ...
    public void getUserGroups_shouldFilterResultsCorrectly() throws Exception {
        ...
        List<UserGroup> ret = DataManager.getInstance()
                .getDao()
                .getUserGroups(0, 2, null, true, filterMap);
        Assert.assertEquals(1, ret.size());
        Assert.assertEquals("user group 2 name", ret.get(0)
                .getName());
    }
    ...
    public void getUsers_shouldSortResultsCorrectly() throws Exception {
        List<User> users = DataManager.getInstance()
                .getDao()
                .getUsers(0, 2, "score", true, null);
        Assert.assertEquals(2, users.size());
        Assert.assertEquals(Long.valueOf(2), users.get(0)
                .getId());
        Assert.assertEquals(Long.valueOf(1), users.get(1)
                .getId());
    }
    ...
    public void getUsers_shouldFilterResultsCorrectly() throws Exception {
        ...
        List<User> ret = DataManager.getInstance()
                .getDao()
                .getUsers(0, 2, null, true, filterMap);
        Assert.assertEquals(1, ret.size());
        Assert.assertEquals("1@users.org", ret.get(0)
                .getEmail());
    }
    ...
    public void getSearches_shouldSortResultsCorrectly() throws Exception {
        List<Search> ret = DataManager.getInstance()
                .getDao()
                .getSearches(null, 0, 10, "name", true, null);
        Assert.assertEquals(3, ret.size());
        Assert.assertEquals(Long.valueOf(3), ret.get(0)
                .getId());
        Assert.assertEquals(Long.valueOf(2), ret.get(1)
                .getId());
        Assert.assertEquals(Long.valueOf(1), ret.get(2)
                .getId());
    }
    ...
    public void getSearches_shouldFilterResultsCorrectly() throws Exception {
        ...
        List<Search> ret = DataManager.getInstance()
                .getDao()
                .getSearches(DataManager.getInstance()
                        .getDao()
                        .getUser(1), 0, 2, null, true, filterMap);
        Assert.assertEquals(1, ret.size());
        Assert.assertEquals("search 1", ret.get(0)
                .getName());
    }
    ...
    public void getRoles_shouldSortResultsCorrectly() throws Exception {
        List<Role> ret = DataManager.getInstance()
                .getDao()
                .getRoles(0, 2, "name", true, null);
        Assert.assertEquals(2, ret.size());
        Assert.assertEquals(Long.valueOf(2), ret.get(0)
                .getId());
        Assert.assertEquals(Long.valueOf(1), ret.get(1)
                .getId());
    }
    ...
    public void getRoles_shouldFilterResultsCorrectly() throws Exception {
        ...
        List<Role> ret = DataManager.getInstance()
                .getDao()
                .getRoles(0, 2, null, true, filterMap);
        Assert.assertEquals(1, ret.size());
        Assert.assertEquals("role 2 name", ret.get(0)
                .getName());
    }
    ...
    public void getLicenseTypes_shouldSortResultsCorrectly() throws Exception {
        List<LicenseType> ret = DataManager.getInstance()
                .getDao()
                .getLicenseTypes(0, 2, "name", true, null);
        Assert.assertEquals(2, ret.size());
        Assert.assertEquals(Long.valueOf(3), ret.get(0)
                .getId());
        Assert.assertEquals(Long.valueOf(2), ret.get(1)
    ...
    public void getLicenseTypes_shouldFilterResultsCorrectly() throws Exception {
        ...
        List<LicenseType> ret = DataManager.getInstance()
                .getDao()
                .getLicenseTypes(0, 2, null, true, filterMap);
        Assert.assertEquals(1, ret.size());
        Assert.assertEquals("license type 2 name", ret.get(0)
                .getName());
    }
    ...
    public void getIpRanges_shouldSortResultsCorrectly() throws Exception {
        List<IpRange> ret = DataManager.getInstance()
                .getDao()
                .getIpRanges(0, 2, "name", true, null);
        Assert.assertEquals(2, ret.size());
        Assert.assertEquals(Long.valueOf(2), ret.get(0)
                .getId());
        Assert.assertEquals(Long.valueOf(1), ret.get(1)
    ...
    public void getIpRanges_shouldFilterResultsCorrectly() throws Exception {
        ...
        List<IpRange> ret = DataManager.getInstance()
                .getDao()
                .getIpRanges(0, 2, null, true, filterMap);
        Assert.assertEquals(1, ret.size());
        Assert.assertEquals("localhost2", ret.get(0)
                .getName());
    }
    ...
    public void getCMSMediaItem_shouldReturnCorrectItem() throws Exception {
        CMSMediaItem item = DataManager.getInstance()
                .getDao()
                .getCMSMediaItem(1);
        Assert.assertNotNull(item);
        Assert.assertEquals(Long.valueOf(1), item.getId());
        Assert.assertEquals("image1.jpg", item.getFileName());
        Assert.assertEquals(2, item.getMetadata()
                .size());
        Assert.assertEquals("de", item.getMetadata()
                .get(0)
                .getLanguage());
        Assert.assertEquals("Bild 1", item.getMetadata()
                .get(0)
                .getName());
        Assert.assertEquals("Beschreibung 1", item.getMetadata()
                .get(0)
                .getDescription());
        Assert.assertEquals("en", item.getMetadata()
                .get(1)
                .getLanguage());
        Assert.assertEquals("Image 1", item.getMetadata()
                .get(1)
                .getName());
        Assert.assertEquals("Description 1", item.getMetadata()
                .get(1)
                .getDescription());
    }
    ...
    public void addCMSMediaItem_shouldAddItemCorrectly() throws Exception {
        ...
        CMSMediaItem item2 = DataManager.getInstance()
                .getDao()
                .getCMSMediaItem(item.getId());
        Assert.assertNotNull(item2);
        Assert.assertEquals(item, item2);
        Assert.assertEquals(item.getFileName(), item2.getFileName());
        Assert.assertEquals(1, item2.getMetadata()
                .size());
        Assert.assertEquals(md, item2.getMetadata()
                .get(0));
        Assert.assertEquals(md.getLanguage(), item2.getMetadata()
                .get(0)
                .getLanguage());
        Assert.assertEquals(md.getName(), item2.getMetadata()
                .get(0)
                .getName());
        Assert.assertEquals(md.getDescription(), item2.getMetadata()
                .get(0)
                .getDescription());
    }
    ...
    public void updateCMSMediaItem_shouldUpdateItemCorrectly() throws Exception {
        ...
        item.getMetadata()
                .remove(item.getMetadata()
                        .get(0));
        Assert.assertTrue(DataManager.getInstance()
                .getDao()
                .updateCMSMediaItem(item));
    ...
    public void getCMSPagesByClassification_shouldReturnAllPagesWithGivenClassification() throws Exception {
        Assert.assertEquals(2, DataManager.getInstance()
                .getDao()
                .getCMSPagesByClassification("news")
                .size());
    }
    ...
    public void getCMSPage_shouldReturnCorrectPage() throws Exception {
        ...
        Assert.assertEquals(2, page.getLanguageVersions()
                .size());
        Assert.assertEquals("de", page.getLanguageVersions()
                .get(0)
                .getLanguage());
        Assert.assertEquals(CMSPageStatus.FINISHED, page.getLanguageVersions()
                .get(0)
                .getStatus());
        Assert.assertEquals("Titel 1", page.getLanguageVersions()
                .get(0)
                .getTitle());
        Assert.assertEquals("Menütitel 1", page.getLanguageVersions()
                .get(0)
                .getMenuTitle());
        ...
        Assert.assertEquals("C1", page.getLanguageVersions()
                .get(0)
                .getContentItems()
                .get(0)
                .getItemId());
        Assert.assertEquals(CMSContentItemType.HTML, page.getLanguageVersions()
                .get(0)
                .getContentItems()
                .get(0)
                .getType());
    ...
    public void addCMSPage_shouldAddPageCorrectly() throws Exception {
        ...
        Assert.assertEquals(4, DataManager.getInstance()
                ...
                .getAllCMSPages()
                .size());
        CMSPage page2 = DataManager.getInstance()
                .getDao()
                .getCMSPage(page.getId());
        ...
        Assert.assertEquals(1, page2.getClassifications()
                .size());
        Assert.assertEquals("class", page2.getClassifications()
                .get(0));
        Assert.assertEquals(1, page.getLanguageVersions()
                .size());
        Assert.assertEquals(version.getLanguage(), page.getLanguageVersions()
                .get(0)
                .getLanguage());
        Assert.assertEquals(version.getTitle(), page.getLanguageVersions()
                .get(0)
                .getTitle());
        Assert.assertEquals(version.getMenuTitle(), page.getLanguageVersions()
                .get(0)
                .getMenuTitle());
        Assert.assertEquals(version.getStatus(), page.getLanguageVersions()
                .get(0)
                .getStatus());
        Assert.assertEquals(1, page.getLanguageVersions()
                .get(0)
                .getContentItems()
                .size());
        Assert.assertEquals(item.getItemId(), page.getLanguageVersions()
                .get(0)
                .getContentItems()
                .get(0)
                .getItemId());
        Assert.assertEquals(item.getType(), page.getLanguageVersions()
                .get(0)
                .getContentItems()
                .get(0)
                .getType());
        Assert.assertEquals(item.isMandatory(), page.getLanguageVersions()
                .get(0)
                .getContentItems()
                .get(0)
                .isMandatory());
        Assert.assertEquals(item.getElementsPerPage(), page.getLanguageVersions()
                .get(0)
                .getContentItems()
                .get(0)
                .getElementsPerPage());
        Assert.assertEquals(item.getSolrQuery(), page.getLanguageVersions()
                .get(0)
                .getContentItems()
                .get(0)
                .getSolrQuery());
        Assert.assertEquals(item.getSolrSortFields(), page.getLanguageVersions()
                .get(0)
                .getContentItems()
                .get(0)
                .getSolrSortFields());
    ...
    public void updateCMSPage_shouldUpdatePageCorrectly() throws Exception {
        ...
        Assert.assertEquals(1, page2.getLanguageVersions()
                .size());
        Assert.assertEquals(3, page2.getClassifications()
                .size());
    ...
    public void getAllTopCMSNavigationItems_shouldReturnAllTopItems() throws Exception {
        ...
        Assert.assertEquals(Long.valueOf(1), items.get(0)
                .getId());
        Assert.assertEquals(Long.valueOf(4), items.get(1)
                .getId());
    }
    ...
    public void getCMSNavigationItem_shouldReturnCorrectItemAndChildItems() throws Exception {
        CMSNavigationItem item = DataManager.getInstance()
                .getDao()
                .getCMSNavigationItem(1);
        Assert.assertNotNull(item);
        Assert.assertEquals(Long.valueOf(1), item.getId());
        ...
        Assert.assertEquals(2, item.getChildItems()
                .size());
        Collections.sort(item.getChildItems());
        Assert.assertEquals(Long.valueOf(2), item.getChildItems()
                .get(0)
                .getId());
        Assert.assertEquals(Long.valueOf(3), item.getChildItems()
                .get(1)
                .getId());
        Assert.assertEquals(Integer.valueOf(1), item.getChildItems()
                .get(0)
                .getOrder());
        Assert.assertEquals(Integer.valueOf(2), item.getChildItems()
                .get(1)
                .getOrder());
    }
    ...
    public void addCMSNavigationItem_shouldAddItemAndChildItemsCorrectly() throws Exception {
        ...
        CMSNavigationItem item2 = DataManager.getInstance()
                .getDao()
                .getCMSNavigationItem(item.getId());
        Assert.assertNotNull(item2);
        Assert.assertEquals(item.getId(), item2.getId());
        Assert.assertEquals(item.getChildItems()
                .size(),
                item2.getChildItems()
                        .size());
        Assert.assertEquals(childItem.getId(), item2.getChildItems()
                .get(0)
                .getId());
    }
    ...
    public void updateCMSNavigationItem_shouldUpdateItemAndChildItemsCorrectly() throws Exception {
        ...
        item.getChildItems()
                .get(0)
                .setPageUrl("new child url");

        Assert.assertTrue(DataManager.getInstance()
                .getDao()
                .updateCMSNavigationItem(item));
        Assert.assertEquals(2, DataManager.getInstance()
                .getDao()
                .getAllTopCMSNavigationItems()
                .size());
    ...
    public void deleteCMSNavigationItem_shouldDeleteItemAndChildItemsCorrectly() throws Exception {
        ...
        Assert.assertNull(DataManager.getInstance()
                .getDao()
                .getCMSNavigationItem(2));
        Assert.assertNull(DataManager.getInstance()
                .getDao()
                .getCMSNavigationItem(3));
    }
    ...
    public void getOverviewPage_shouldLoadOverviewPageCorrectly() throws Exception {
        OverviewPage op = DataManager.getInstance()
                .getDao()
                .getOverviewPage(1);
    ...
    public void getOverviewPageForRecord_shouldLoadOverviewPageCorrectly() throws Exception {
        OverviewPage op = DataManager.getInstance()
                .getDao()
                .getOverviewPageForRecord("PI 1", null, null);
        Assert.assertNotNull(op);
        Assert.assertEquals(Long.valueOf(1), op.getId());
        Assert.assertEquals("PI 1", op.getPi());
        Assert.assertNotNull(op.getConfigXml());
    ...
    public void addOverviewPage_shouldAddOverviewPageCorrectly() throws Exception {
        ...
        Assert.assertTrue(DataManager.getInstance()
                .getDao()
                .addOverviewPage(op));
        OverviewPage op2 = DataManager.getInstance()
                .getDao()
                .getOverviewPage(op.getId());
    ...
    public void getOverviewPages_shouldReturnAllOverviewPages() throws Exception {
        {
            List<OverviewPage> overviewPages = DataManager.getInstance()
                    .getDao()
                    .getOverviewPages(0, 10, null, null);
            Assert.assertNotNull(overviewPages);
            Assert.assertEquals(3, overviewPages.size());
            Assert.assertEquals("PI 1", overviewPages.get(0)
                    .getPi());
        }
        {
            Date fromDate = DateTools.parseDateFromString("2015-06-21");
            ...
            List<OverviewPage> overviewPages = DataManager.getInstance()
                    .getDao()
                    .getOverviewPages(0, 10, fromDate, null);
            Assert.assertNotNull(overviewPages);
    ...
    public void getOverviewPages_shouldPaginateResultsCorrectly() throws Exception {
        {
            List<OverviewPage> overviewPages = DataManager.getInstance()
                    .getDao()
                    .getOverviewPages(0, 1, null, null);
            Assert.assertNotNull(overviewPages);
            Assert.assertEquals(1, overviewPages.size());
            Assert.assertEquals("PI 1", overviewPages.get(0)
                    .getPi());
        }
        {
            List<OverviewPage> overviewPages = DataManager.getInstance()
                    .getDao()
                    .getOverviewPages(1, 1, null, null);
            Assert.assertNotNull(overviewPages);
            Assert.assertEquals(1, overviewPages.size());
            Assert.assertEquals("PI 2", overviewPages.get(0)
                    .getPi());
        }
    }
    ...
    public void getOverviewPageUpdatesForRecord_shouldReturnAllUpdatesForRecord() throws Exception {
        Assert.assertEquals(3, DataManager.getInstance()
                .getDao()
                .getOverviewPageUpdatesForRecord("PI 1")
                .size());
    }
    ...
    public void getOverviewPageUpdatesForRecord_shouldSortUpdatesByDateDescending() throws Exception {
        List<OverviewPageUpdate> updates = DataManager.getInstance()
                .getDao()
                .getOverviewPageUpdatesForRecord("PI 1");
        Assert.assertEquals(3, DataManager.getInstance()
                .getDao()
                .getOverviewPageUpdatesForRecord("PI 1")
                .size());
        Assert.assertEquals(Long.valueOf(3), updates.get(0)
                .getId());
        Assert.assertEquals(Long.valueOf(2), updates.get(1)
                .getId());
        Assert.assertEquals(Long.valueOf(1), updates.get(2)
                .getId());
    }
    ...
    public void isOverviewPageHasUpdates_shouldReturnStatusCorrectly() throws Exception {
        Assert.assertTrue(DataManager.getInstance()
                .getDao()
                .isOverviewPageHasUpdates("PI 1", null, null));

        Date fromDate = DateTools.parseDateFromString("2015-06-21");
        Date toDate = DateTools.parseDateFromString("2015-06-23");
        Assert.assertTrue(DataManager.getInstance()
                .getDao()
                .isOverviewPageHasUpdates("PI 1", fromDate, toDate));
    ...
    public void getOverviewPageUpdate_shouldLoadObjectCorrectly() throws Exception {
        OverviewPageUpdate update = DataManager.getInstance()
                .getDao()
                .getOverviewPageUpdate(3);
        ...
        Assert.assertEquals(Long.valueOf(1), update.getUpdatedBy()
                .getId());
    ...
    public void addOverviewPageUpdate_shouldAddUpdateCorrectly() throws Exception {
        ...
        Date now = new Date();
        o.setDateUpdated(now);
        o.setUpdatedBy(DataManager.getInstance()
                .getDao()
                .getUser(1));
        o.setConfig("config");
        ...
        OverviewPageUpdate o2 = DataManager.getInstance()
                .getDao()
                .getOverviewPageUpdate(o.getId());
        Assert.assertNotNull(o2);
    ...
    public void deleteOverviewPageUpdate_shouldDeleteUpdateCorrectly() throws Exception {
        Assert.assertEquals(3, DataManager.getInstance()
                ...
                .getOverviewPageUpdatesForRecord("PI 1")
                .size());
        OverviewPageUpdate o = DataManager.getInstance()
                .getDao()
                .getOverviewPageUpdate(1);
        Assert.assertNotNull(o);
        Assert.assertTrue(DataManager.getInstance()
                .getDao()
                .deleteOverviewPageUpdate(o));
        Assert.assertNull(DataManager.getInstance()
                .getDao()
                .getOverviewPageUpdate(1));
        Assert.assertEquals(2, DataManager.getInstance()
    ...
    public void getUserCount_shouldReturnCorrectCount() throws Exception {
        Assert.assertEquals(2L, DataManager.getInstance()
                .getDao()
                .getUserCount(null));
    }
    ...
    public void getUserCount_shouldFilterCorrectly() throws Exception {
        ...
        Assert.assertEquals(1L, DataManager.getInstance()
                .getDao()
    ...
    public void getDownloadJob_shouldReturnCorrectObject() throws Exception {
        {
            ...
            Assert.assertEquals(1, job.getObservers()
                    .size());
            Assert.assertEquals("viewer@intranda.com", job.getObservers()
                    .get(0));
        }
        {
            DownloadJob job = DataManager.getInstance()
    ...
    public void getDownloadJobByIdentifier_shouldReturnCorrectObject() throws Exception {
        DownloadJob job = DataManager.getInstance()
                .getDao()
                .getDownloadJobByIdentifier("70eef211dc8a5889578f58d88eb50b8e");
        Assert.assertNotNull(job);
        Assert.assertEquals(PDFDownloadJob.class, job.getClass());
        Assert.assertEquals(Long.valueOf(1), job.getId());
        Assert.assertEquals("PI 1", job.getPi());
    ...
    public void getDownloadJobByMetadata_shouldReturnCorrectObject() throws Exception {
        {
            DownloadJob job = DataManager.getInstance()
                    .getDao()
                    .getDownloadJobByMetadata(PDFDownloadJob.TYPE, "PI 1", null);
            Assert.assertNotNull(job);
            Assert.assertEquals(PDFDownloadJob.class, job.getClass());
            Assert.assertEquals(Long.valueOf(1), job.getId());
        }
        {
            DownloadJob job = DataManager.getInstance()
                    .getDao()
                    .getDownloadJobByMetadata(EPUBDownloadJob.TYPE, "PI 1", "LOG_0001");
            Assert.assertNotNull(job);
            Assert.assertEquals(EPUBDownloadJob.class, job.getClass());
    ...
    public void addDownloadJob_shouldAddObjectCorrectly() throws Exception {
        ...
        DownloadJob job2 = DataManager.getInstance()
                .getDao()
                .getDownloadJob(job.getId());
    ...
    public void updateDownloadJob_shouldUpdateObjectCorrectly() throws Exception {
        ...
        Assert.assertEquals(2, job2.getObservers()
                .size());
        Assert.assertEquals("newobserver@example.com", job2.getObservers()
                .get(1));
    }
    ...
    public void getCMSPagesCount_shouldReturnCorrectCount() throws Exception {
        long numPages = DataManager.getInstance()
                .getDao()
                .getCMSPageCount(Collections.EMPTY_MAP);
    ...
    public void getStaticPageForCMSPage_shouldReturnCorrectResult() throws Exception {
        ...
        for (CMSPage page : cmsPages) {
            Optional<CMSStaticPage> staticPage = DataManager.getInstance()
                    .getDao()
                    .getStaticPageForCMSPage(page);
            if (page.getId()
                    .equals(1l)) {
                Assert.assertTrue(staticPage.isPresent());
                Assert.assertTrue(staticPage.get()
                        .getPageName()
                        .equals("index"));
                Assert.assertTrue(staticPage.get()
                        .getCmsPage()
