...
public class JPADAOTest extends AbstractDatabaseEnabledTest {
    ...
    public void getSearchByIdTest() throws DAOException {
        ...
        Assert.assertEquals("collection 1", o.getCollection());
        Assert.assertEquals("sort 1", o.getSortField());
        Assert.assertEquals("filter 1", o.getFilter());
    ...
    public void addSearchTest() throws DAOException {
        ...
        o.setQuery("PI:*");
        o.setPage(1);
        o.setCollection("newcol");
        o.setSortField("SORT_FIELD");
        o.setFilter("DC:Other");
        Date now = new Date();
        ...
        Assert.assertEquals(o.getCollection(), o2.getCollection());
        Assert.assertEquals(o.getSortField(), o2.getSortField());
        Assert.assertEquals(o.getFilter(), o2.getFilter());
