...
public class TocMakerTest extends AbstractDatabaseAndSolrEnabledTest {
    ...
    public void generateToc_shouldGenerateVolumeTOCCorrectlyWithSiblingsCorrectly() throws Exception {
        long iddoc = DataManager.getInstance()
                .getSearchIndex()
                .getIddocFromIdentifier("ZDB026544598_0001");
        ...
        Assert.assertEquals(302, tocElements.get(TOC.DEFAULT_GROUP)
                .size()); // 1 anchor + 290 elements of volume ZDB026544598_0001 + 11 sibling volume top elements
        // Anchor first
        Assert.assertEquals("ZDB026544598", tocElements.get(TOC.DEFAULT_GROUP)
                .get(0)
                .getTopStructPi());
        // First volume (complete tree)
        for (int i = 1; i <= 290; ++i) {
            TOCElement element = tocElements.get(TOC.DEFAULT_GROUP)
                    .get(i);
            Assert.assertEquals("ZDB026544598_0001", element.getTopStructPi());
        }
        // Sibling volumes (just topstruct)
        Assert.assertEquals("ZDB026544598_0002", tocElements.get(TOC.DEFAULT_GROUP)
                .get(291)
                .getTopStructPi());
        Assert.assertEquals("ZDB026544598_0003", tocElements.get(TOC.DEFAULT_GROUP)
                .get(292)
                .getTopStructPi());
        Assert.assertEquals("ZDB026544598_0004", tocElements.get(TOC.DEFAULT_GROUP)
                .get(293)
                .getTopStructPi());
        Assert.assertEquals("ZDB026544598_0005", tocElements.get(TOC.DEFAULT_GROUP)
                .get(294)
                .getTopStructPi());
        Assert.assertEquals("ZDB026544598_0006", tocElements.get(TOC.DEFAULT_GROUP)
                .get(295)
                .getTopStructPi());
        Assert.assertEquals("ZDB026544598_0007", tocElements.get(TOC.DEFAULT_GROUP)
                .get(296)
                .getTopStructPi());
        Assert.assertEquals("ZDB026544598_0008", tocElements.get(TOC.DEFAULT_GROUP)
                .get(297)
                .getTopStructPi());
        Assert.assertEquals("ZDB026544598_0009", tocElements.get(TOC.DEFAULT_GROUP)
                .get(298)
                .getTopStructPi());
        Assert.assertEquals("ZDB026544598_0010", tocElements.get(TOC.DEFAULT_GROUP)
                .get(299)
                .getTopStructPi());
        Assert.assertEquals("ZDB026544598_0011", tocElements.get(TOC.DEFAULT_GROUP)
                .get(300)
                .getTopStructPi());
        Assert.assertEquals("ZDB026544598_0012", tocElements.get(TOC.DEFAULT_GROUP)
                .get(301)
                .getTopStructPi());
    }
    ...
    public void generateToc_shouldGenerateVolumeTOCCorrectlyWithoutSiblingsCorrectly() throws Exception {
        ...
        Assert.assertNotNull(tocElements);
        Assert.assertNotNull(tocElements.get(TOC.DEFAULT_GROUP));
        Assert.assertEquals(291, tocElements.get(TOC.DEFAULT_GROUP)
                .size()); // 1 anchor + 290 elements of volume ZDB026544598_0001
        // Anchor first
        Assert.assertEquals("ZDB026544598", tocElements.get(TOC.DEFAULT_GROUP)
                .get(0)
                .getTopStructPi());
    ...
    public void generateToc_shouldGenerateAnchorTOCCorrectly() throws Exception {
        long iddoc = DataManager.getInstance()
                .getSearchIndex()
                .getIddocFromIdentifier("ZDB026544598");
        Assert.assertTrue(iddoc > 0);
        StructElement structElement = new StructElement(iddoc);
        TOC toc = new TOC();
        ...
        Assert.assertNotNull(tocElements);
        Assert.assertNotNull(tocElements.get(TOC.DEFAULT_GROUP));
        Assert.assertEquals(13, tocElements.get(TOC.DEFAULT_GROUP)
                .size());
        Assert.assertEquals(12, toc.getTotalTocSize());
        Assert.assertEquals("ZDB026544598", tocElements.get(TOC.DEFAULT_GROUP)
                .get(0)
                .getTopStructPi());
        for (int i = 1; i < tocElements.get(TOC.DEFAULT_GROUP)
                .size(); ++i) {
            Assert.assertEquals(i < 10 ? "ZDB026544598_000" + i : "ZDB026544598_00" + i, tocElements.get(TOC.DEFAULT_GROUP)
                    .get(i)
                    .getTopStructPi());
        }
    }
    ...
    public void generateToc_shouldPaginateAnchorTOCCorrectly() throws Exception {
        ...
        TOC toc = new TOC();
        {
            ...
            Assert.assertNotNull(tocElements);
            Assert.assertNotNull(tocElements.get(TOC.DEFAULT_GROUP));
            Assert.assertEquals(6, tocElements.get(TOC.DEFAULT_GROUP)
                    .size());
            Assert.assertEquals(12, toc.getTotalTocSize());
            Assert.assertEquals("ZDB026544598", tocElements.get(TOC.DEFAULT_GROUP)
                    .get(0)
            ...
            for (int i = 1; i < tocElements.get(TOC.DEFAULT_GROUP)
                    .size(); ++i) {
                Assert.assertEquals("ZDB026544598_000" + i, tocElements.get(TOC.DEFAULT_GROUP)
                        .get(i)
                        .getTopStructPi());
            }
        }
        ...
        }
        {
            ...
            Assert.assertNotNull(tocElements);
            Assert.assertNotNull(tocElements.get(TOC.DEFAULT_GROUP));
            Assert.assertEquals(3, tocElements.get(TOC.DEFAULT_GROUP)
                    .size());
            Assert.assertEquals(12, toc.getTotalTocSize());
            Assert.assertEquals("ZDB026544598", tocElements.get(TOC.DEFAULT_GROUP)
                    .get(0)
            ...
            for (int i = 1; i < tocElements.get(TOC.DEFAULT_GROUP)
                ...
                Assert.assertEquals("ZDB026544598_00" + volumeNumber, tocElements.get(TOC.DEFAULT_GROUP)
                        .get(i)
                        .getTopStructPi());
            }
        }
    ...
    public void buildLabel_shouldBuildConfiguredLabelCorrectly() throws Exception {
        {
            ...
            Assert.assertEquals("label / creator", TocMaker.buildLabel(doc)
                    .getValue()
                    .orElse(""));
        }
        {
            ...
            Assert.assertEquals("Number 1: title", TocMaker.buildLabel(doc)
                    .getValue()
                    .orElse(""));
        }
    }
